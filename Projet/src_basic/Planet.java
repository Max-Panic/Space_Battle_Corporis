...
public class Planet 
{
	...
	public Planet(Game g, int owner)  
	{
		...
		{
			this.productionRate = 1; //assignation provisoire du taux de production de la planï¿½te ï¿½ 1
	...
	public void launch(Game g, Planet target, Player player)	
	{
		...
		//Squadron squadron = new Squadron(1, 1, shipLaunchedNbr, target.id); <- crï¿½ation d'un escadron contenant les vaisseaux lancï¿½s ï¿½ implï¿½menter
